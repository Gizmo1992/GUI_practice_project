...
def save_invoice():
    ...
    my_file = filedialog.asksaveasfile(mode='w', defeaultextension=".txt")
    my_file.write(invoice_info)
    my_file.close()
    messagebox.showinfo('Notification', 'Your info has been saved')
...
# Product lists
food_list = ['Chicken', 'Lamb', 'Salmon', 'Hake', 'Kebabs', 'Pizza1',
             'Pizza2', 'Pizza3']
drink_list= ['Lemonade', 'Soda', 'Juice', 'Cola', 'Wine1', 'Wine2',
             'Beer1', 'Beer2']
dessert_list= ['Ice cream', 'Fruit', 'Brownies', 'Pudding', 'Cheesecake',
               'Cake1', 'Cake2', 'Cake3']
